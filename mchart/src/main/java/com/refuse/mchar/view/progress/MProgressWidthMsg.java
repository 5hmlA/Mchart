...
public class MProgressWidthMsg extends View {
    ...
    public MProgressWidthMsg(Context context, AttributeSet attrs, int defStyle){
        ...
        if(attrs != null) {
            ...
            msgColor = typedArray.getColor(R.styleable.MProgressWidthMsg_msgColor, Color.BLACK);
            backColor = typedArray.getColor(R.styleable.MProgressWidthMsg_backColor, Color.TRANSPARENT);
            ...
            current = typedArray.getFloat(R.styleable.MProgressWidthMsg_currprogress, 50);
            Max = typedArray.getFloat(R.styleable.MProgressWidthMsg_maxprogress, 100);
            msgMode = typedArray.getInt(R.styleable.MProgressWidthMsg_msgMode, 0);
            typedArray.recycle();
        }
        init();
    }
